...
###############################################################################
	.data
		randomLine: .asciiz "===>   You are after passing 500 iterations.   <===\n\n"	#TODO 1
	.globl main
	.text
	
main:
	li $t1, 500		###TODO 1
	#j infinite_loop		###for testing TODO 1
	...
	lui $t0, 0xffff
	ori $a0, $0, 2			#enables keyboard interrupt
	sw $a0, 0($t0)
...
FIRED_BIT:		.asciiz "===>	    Bit x has been fired      <===\n"
...
__interrupt: 
	...
	beq $k0, 256, __keyboard_interrupt
